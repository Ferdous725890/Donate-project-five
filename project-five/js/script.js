...
//     const historyItems = document.createElement('div');
//     historyItems.className = "border p-8 rounded-md mb-3";
//     historyItems.innerHTML = `<h1 class="text-xl font-bold">${firstDonetInput} Donate for Flood at Noakhali, Bangladesh</h1>`;
...
//     "border p-8 rounded-md mb-3"
// historyItems.innerHTML = `

// <h1 class="text-xl font-bold"> ${firstDonetInput} Donate for Flood at Noakhali, Bangladesh</h1>
...
//     const historyConteiner = document.getElementById('history-list');
// historyConteiner.classList.remove(
//     "hidden"
// )
...
// const historyConteiner = document.getElementById('history-list');
// historyConteiner.classList.add(
//     "hidden"
// )
